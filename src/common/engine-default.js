const df_401_1 = new (require('@comunica/logger-void').LoggerVoid)();
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__2_0_0_components_ActorInit_jsonld_ActorInit_default_bus =
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__2_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus =
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_parse__2_0_0_components_ActorQueryParse_jsonld_ActorQueryParse_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_result_serialize__2_0_0_components_ActorQueryResultSerialize_jsonld_ActorQueryResultSerialize_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_context_preprocess__2_0_0_components_ActorContextPreprocess_jsonld_ActorContextPreprocess_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http_invalidate__2_0_0_components_ActorHttpInvalidate_jsonld_ActorHttpInvalidate_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_extract_links__0_0_0_components_ActorExtractLinks_jsonld_ActorExtractLinks_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__2_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__2_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_bindings__2_0_0_components_ActorHashBindings_jsonld_ActorHashBindings_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__2_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__2_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference__2_0_0_components_ActorDereference_jsonld_ActorDereference_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__2_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rdf__2_0_0_components_ActorDereferenceRdf_jsonld_ActorDereferenceRdf_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_entries_sort__2_0_0_components_ActorRdfJoinEntriesSort_jsonld_ActorRdfJoinEntriesSort_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_selectivity__2_0_0_components_ActorRdfJoinSelectivity_jsonld_ActorRdfJoinSelectivity_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__2_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__2_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__2_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia__2_0_0_components_ActorRdfResolveHypermedia_jsonld_ActorRdfResolveHypermedia_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia__2_0_0_components_ActorRdfUpdateHypermedia_jsonld_ActorRdfUpdateHypermedia_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads__2_0_0_components_ActorRdfUpdateQuads_jsonld_ActorRdfUpdateQuads_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__2_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus =
    new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern__2_0_0_components_ActorRdfResolveQuadPattern_jsonld_ActorRdfResolveQuadPattern_default_bus =
    new (require('@comunica/core').Bus)({
...
const urn_comunica_default_optimize_query_operation_actors_set_seed_sources_quadpattern_iris =
    new (require('@comunica/actor-optimize-query-operation-set-seed-sources-quadpattern-iris').ActorOptimizeQueryOperationSetSeedSourcesQuadpatternIris)(
        {
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_update_quads_hypermedia__2_0_0_components_ActorRdfUpdateQuadsHypermedia_jsonld_IActorRdfUpdateQuadsHypermediaArgs_default_invalidator =
...
const urn_comunica_default_extract_links_actors_quad_pattern_query =
    new (require('@comunica/actor-extract-links-quad-pattern-query').ActorExtractLinksQuadPatternQuery)({
        onlyVariables: true,
...
const urn_comunica_default_extract_links_mediators_main =
    new (require('@comunica/mediator-combine-array').MediatorCombineArray)({
        fields: ['links', 'linksConditional'],
...
const urn_comunica_default_rdf_resolve_hypermedia_links_actors_traverse =
    new (require('@comunica/actor-rdf-resolve-hypermedia-links-traverse').ActorRdfResolveHypermediaLinksTraverse)({
...
const urn_comunica_default_hash_bindings_actors_sha1 =
    new (require('@comunica/actor-hash-bindings-sha1').ActorHashBindingsSha1)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__2_0_0_components_ActorQueryResultSerializeStats_jsonld_ActorQueryResultSerializeStats_default_observer =
...
const urn_comunica_default_rdf_join_entries_sort_actors_traversal_zero_knowledge =
    new (require('@comunica/actor-rdf-join-entries-sort-traversal-zero-knowledge').ActorRdfJoinEntriesSortTraversalZeroKnowledge)(
        {
...
const urn_comunica_default_rdf_parse_actors_html = new (require('@comunica/actor-rdf-parse-html').ActorRdfParseHtml)({
    busRdfParseHtml:
        https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__2_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus,
...
const urn_comunica_default_rdf_resolve_hypermedia_actors_none =
    new (require('@comunica/actor-rdf-resolve-hypermedia-none').ActorRdfResolveHypermediaNone)({
...
const urn_comunica_default_rdf_resolve_hypermedia_mediators_main =
    new (require('@comunica/mediator-number').MediatorNumber)({
        field: 'filterFactor',
        type: 'max',
        ignoreErrors: true,
...
const urn_comunica_default_rdf_resolve_quad_pattern_mediators_main =
    new (require('@comunica/mediator-race').MediatorRace)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_rdfjs_source =
    new (require('@comunica/actor-rdf-resolve-quad-pattern-rdfjs-source').ActorRdfResolveQuadPatternRdfJsSource)({
...
const urn_comunica_default_query_operation_actors_describe =
    new (require('@comunica/actor-query-operation-describe-subject').ActorQueryOperationDescribeSubject)({
        mediatorQueryOperation: urn_comunica_default_query_operation_mediators_main,
...
const urn_comunica_default_query_operation_actors_orderby =
    new (require('@comunica/actor-query-operation-orderby-sparqlee').ActorQueryOperationOrderBySparqlee)({
        mediatorQueryOperation: urn_comunica_default_query_operation_mediators_main,
...
const urn_comunica_default_query_operation_actors_update_add =
    new (require('@comunica/actor-query-operation-update-add-rewrite').ActorQueryOperationAddRewrite)({
        mediatorQueryOperation: urn_comunica_default_query_operation_mediators_main,
        name: 'urn:comunica:default:query-operation/actors#update-add',
        bus: https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__2_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus,
    });
const urn_comunica_default_query_operation_actors_update_copy =
    new (require('@comunica/actor-query-operation-update-copy-rewrite').ActorQueryOperationCopyRewrite)({
        mediatorQueryOperation: urn_comunica_default_query_operation_mediators_main,
...
const urn_comunica_default_query_operation_actors_update_move =
    new (require('@comunica/actor-query-operation-update-move-rewrite').ActorQueryOperationMoveRewrite)({
        mediatorQueryOperation: urn_comunica_default_query_operation_mediators_main,
...
const urn_comunica_default_rdf_metadata_extract_actors_traverse =
    new (require('@comunica/actor-rdf-metadata-extract-traverse').ActorRdfMetadataExtractTraverse)({
...
const urn_comunica_default_query_operation_actors_distinct =
    new (require('@comunica/actor-query-operation-distinct-hash').ActorQueryOperationDistinctHash)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_sparql =
    new (require('@comunica/actor-rdf-resolve-hypermedia-sparql').ActorRdfResolveHypermediaSparql)({
        mediatorHttp: urn_comunica_default_http_mediators_main,
        checkUrlSuffix: true,
        forceHttpGet: false,
...
const urn_comunica_default_query_operation_actors_sparql_endpoint =
    new (require('@comunica/actor-query-operation-sparql-endpoint').ActorQueryOperationSparqlEndpoint)({
        mediatorHttp: urn_comunica_default_http_mediators_main,
        checkUrlSuffixSparql: true,
        checkUrlSuffixUpdate: true,
        forceHttpGet: false,
...
const urn_comunica_default_rdf_join_actors_inner_hash =
...
const urn_comunica_default_rdf_join_actors_minus_hash =
...
const urn_comunica_default_rdf_join_actors_minus_hash_undef =
    new (require('@comunica/actor-rdf-join-minus-hash-undef').ActorRdfJoinMinusHashUndef)({
        mediatorJoinSelectivity: urn_comunica_default_rdf_join_selectivity_mediators_main,
...
const urn_comunica_default_rdf_resolve_hypermedia_actors_qpf =
    new (require('@comunica/actor-rdf-resolve-hypermedia-qpf').ActorRdfResolveHypermediaQpf)({
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_hypermedia =
    new (require('@comunica/actor-rdf-resolve-quad-pattern-hypermedia').ActorRdfResolveQuadPatternHypermedia)({
        cacheSize: 2048,
        httpInvalidator:
...
const urn_comunica_default_query_operation_actors_quadpattern =
...
const urn_comunica_default_rdf_resolve_quad_pattern_actors_federated =
    new (require('@comunica/actor-rdf-resolve-quad-pattern-federated').ActorRdfResolveQuadPatternFederated)({
        mediatorResolveQuadPattern: urn_comunica_default_rdf_resolve_quad_pattern_mediators_main,
        skipEmptyPatterns: false,
        name: 'urn:comunica:default:rdf-resolve-quad-pattern/actors#federated',
        bus: https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_quad_pattern__2_0_0_components_ActorRdfResolveQuadPattern_jsonld_ActorRdfResolveQuadPattern_default_bus,
    });
const urn_comunica_default_rdf_resolve_hypermedia_links_queue_actors_wrapper_limit_count =
    new (require('@comunica/actor-rdf-resolve-hypermedia-links-queue-wrapper-limit-count').ActorRdfResolveHypermediaLinksQueueWrapperLimitCount)(
        {
            ...
            bus: https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__2_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus,
            beforeActors: [urn_comunica_default_rdf_resolve_hypermedia_links_queue_actors_fifo],
        },
    );
const urn_comunica_default_rdf_resolve_hypermedia_links_actors_traverse_replace_conditional =
    new (require('@comunica/actor-rdf-resolve-hypermedia-links-traverse-replace-conditional').ActorRdfResolveHypermediaLinksTraverseReplaceConditional)(
        {
            mediatorRdfResolveHypermediaLinks: urn_comunica_default_rdf_resolve_hypermedia_links_mediators_main,
            name: 'urn:comunica:default:rdf-resolve-hypermedia-links/actors#traverse-replace-conditional',
            bus: https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__2_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus,
            beforeActors: [urn_comunica_default_rdf_resolve_hypermedia_links_actors_traverse],
        },
    );
const urn_comunica_default_http_actors_inrupt_solid_client_authn =
    new (require('@comunica/actor-http-inrupt-solid-client-authn').ActorHttpInruptSolidClientAuthn)({
        mediatorHttp: urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_extract_links_actors_content_policies_conditional =
    new (require('@comunica/actor-extract-links-content-policies').ActorExtractLinksContentPolicies)({
...
const urn_comunica_default_http_actors_proxy = new (require('@comunica/actor-http-proxy').ActorHttpProxy)({
    ...
    bus: https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__2_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus,
    beforeActors: [urn_comunica_default_http_actors_fetch, urn_comunica_default_http_actors_inrupt_solid_client_authn],
});
const urn_comunica_default_Runner =
    (https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__2_0_0_components_ActorInit_jsonld_ActorInit_default_bus,
    [
