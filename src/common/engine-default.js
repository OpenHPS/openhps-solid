const df_403_1 = new (require('@comunica/logger-void').LoggerVoid)();
...
const urn_comunica_default_rdf_resolve_hypermedia_links_actors_traverse = new (require('./ActorRdfResolveHypermediaLinksTraverse').ActorRdfResolveHypermediaLinksTraverse)({
